...
public class StudentView extends JFrame {
	 ...
	 * @throws SQLException 
	 */
	public StudentView(Connection con, String email) throws SQLException {
	...
	public void events()
	{
		...
		cAssignments.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int result = JOptionPane.showConfirmDialog(getParent(), "Are you sure you want to pick up this assignment?", "Assignment Pick-Up Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, new ImageIcon(new ImageIcon(StudentView.class.getResource("/resources/Dining Logo.png")).getImage().getScaledInstance(64, 64, Image.SCALE_DEFAULT)));
