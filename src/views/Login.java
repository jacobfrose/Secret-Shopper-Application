...
public class Login extends JFrame {
	...
	public void initialize()
	{
		...
		DynamicCombobox.updateComboBox((DefaultComboBoxModel) cShopperType.getModel(), cShopperType, "user_type", "user_types", "user_type_id > 0", con);
					...
					while(result.next())
					{
						if(result.getString(1).equals(tEmail.getText()) && result.getString(2).equals(tPassword.getText()))
						{
							if(cShopperType.getSelectedItem().toString().equals("ISU Dining Student Employee"))
							{
								...
								UserView app = new UserView(con, tEmail.getText());
								app.setVisible(true);
								dispose();
							}
							else
